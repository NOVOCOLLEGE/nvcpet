...
function App() {
  ...
  const AddPost = async () => {
    ...
    await addPostService(namePost.current.value, description.current.value, post.current.value, author.current.value)
  }
  ...
  return (
    <>
      <div className="container">
        ...
        <input ref={post} placeholder="post" type="text" />
